# Procédure – Création d'un dashboard Power BI
...
| Fichier | Description |
|---|---|
| `2026.03 - Power BI - procédure création graphiques - Aeroworld - LM.pdf` | Procédure illustrée de création du dashboard |
